...
<head>
    ...
    <style>
        ...
        .styled-table thead tr {
            background-color: #ff0; /* Cabeçalho amarelo */
            color: #000; /* Texto do cabeçalho preto */
        }

        .styled-table th, .styled-table td {
            padding: 12px 15px;
            border: 1px solid #ff0; /* Bordas amarelas */
            text-align: center;
            color: #fff; /* Texto branco para o corpo */
        }

        .styled-table tbody tr {
            background-color: #333; /* Fundo das linhas */
        }
        ...
        a {
            ...
            padding: 10px 20px;
            background-color: #ff0; /* Botões amarelos */
            color: #000; /* Texto dos botões preto */
            border-radius: 5px;
        ...
        a:hover {
            background-color: #ffd700; /* Mais claro ao passar o mouse */
        }
